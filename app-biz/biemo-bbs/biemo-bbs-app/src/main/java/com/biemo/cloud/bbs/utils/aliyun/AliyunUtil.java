...
import com.biemo.cloud.bbs.utils.SystemUtil;
...
public final class AliyunUtil {
	...
	public static String uploadPic(String filedir, File file, Aliyun aliyun) {
		// 上传
		try {
			String name = file.getName();
			String filePath = filedir.toLowerCase() + "/" + StringUtils.get32UUID() + name.substring(name.lastIndexOf("."));
	...
	public static String uploadPic(String filedir, MultipartFile file, Aliyun aliyun) {
		// 上传
		InputStream in = null;
		try {
	...
	public static String uploadDoc(String filedir, File file, Aliyun aliyun) {
		// 上传
		try {
			String name = file.getName();
			String filePath = filedir.toLowerCase() + "/" + StringUtils.get32UUID() + name.substring(name.lastIndexOf("."));
	...
	public static String uploadDoc(String filedir, MultipartFile file, Aliyun aliyun) {
		InputStream in = null;
		// 上传
		try {
			in = file.getInputStream();
