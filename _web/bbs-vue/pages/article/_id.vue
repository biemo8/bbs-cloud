    ...
    <div class="container main-container left-main size-320">
            ...
            <div class="article-header">
              ...
              <div class="article-meta">
                ...
                >
                  ...
                  >
                    <nuxt-link :to="'/articles/' + tag.id" class>{{
                      tag.name
                    }}</nuxt-link>
                  </span>
                </span>
                ...
                <div class="article-tool">
                  ...
                  <span v-if="hasPermission">
                    <nuxt-link :to="'/article/edit/' + article.id">
                      <i class="iconfont icon-edit" />&nbsp;修改
                    </nuxt-link>
                  </span>
                  <span>
                    <a @click="addFavorite(article.id)">
      ...
      <div class="right-container">
        ...
        <div v-if="nearlyArticles && nearlyArticles.length" class="widget">
          ...
          <div class="widget-content article-related">
            <ul>
              <li v-for="a in nearlyArticles" :key="a.id">
                <nuxt-link
                  :to="'/article/' + a.id"
                  :title="a.title"
                  class="article-related-title"
  ...
  async asyncData({ $axios, params, error }) {
    ...
    const [commentsPage, favorited, nearlyArticles, relatedArticles] =
      await Promise.all([
        ...
        $axios.get('/api/article/nearly/' + article.id),
        $axios.get('/api/article/related/' + article.id),
      ])
